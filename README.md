...
The evaluation results for SeqXGPT-Bench dataset are as follows:

**Note**: All the values listed in our table are **F1 scores**, and **Macro-F1 scores** to consider the overall performance. For detailed precision and recall scores, please refer to our [paper](https://arxiv.org/abs/2310.08903).
...
| **Our implementation**      | **98.6** | **95.8** | **97.2** | **SeqXGPT**      | **98.8** | **96.4** | **97.6** | 
...
| **Our implementation**      | **97.9** | **92.9** | **95.4** | **SeqXGPT**      | **96.0** | **89.9** | **92.9** | 
...
| **Our implementation**      | **97.6** | **92.9** |   95.3   | 
...
| **Our implementation**      | **98.5** | **98.7** | **97.2** | **93.2** |   93.9   | **92.9** | **95.7** | 
